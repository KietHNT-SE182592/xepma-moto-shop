...
const Index = () => {
  ...
  const categories = [
    { name: "Phụ tùng Honda", image: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=500", productCount: 156, link: "/products?category=honda" },
    { name: "Phụ tùng Yamaha", image: "https://images.unsplash.com/photo-1449426468159-d96dbf08f19f?w=500", productCount: 142, link: "/products?category=yamaha" },
    { name: "Phụ tùng Suzuki", image: "https://images.unsplash.com/photo-1568772585407-9361f9bf3a87?w=500", productCount: 98, link: "/products?category=suzuki" },
    { name: "Phụ tùng SYM", image: "https://images.unsplash.com/photo-1609630875171-b1321377ee65?w=500", productCount: 76, link: "/products?category=sym" },
  ];
  ...
  const features = [
    { icon: Shield, title: "Hàng chính hãng", desc: "100% phụ tùng chính hãng" },
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-2xl text-secondary-foreground">
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <Link to="/contact">
                  <Button size="lg" variant="outline" className="text-lg bg-background/10 hover:bg-background/20 border-background/30">
                    Liên hệ ngay
                  </Button>
                </Link>
              </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground text-lg">Phụ tùng chính hãng cho mọi hãng xe</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-12">
            <div>
              ...
              <p className="text-muted-foreground text-lg">Được khách hàng tin dùng nhất</p>
            </div>
            <Link to="/products">
